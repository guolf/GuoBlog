...
public class ColumnUtils {
    ...
    public static String getColumnNameByField(Field field) {
        cn.guolf.guoblog.lib.database.annotation.Column column = field.getAnnotation(cn.guolf.guoblog.lib.database.annotation.Column.class);
        if (column != null && !TextUtils.isEmpty(column.column())) {
            return column.column();
        }

        cn.guolf.guoblog.lib.database.annotation.Id id = field.getAnnotation(cn.guolf.guoblog.lib.database.annotation.Id.class);
        if (id != null && !TextUtils.isEmpty(id.column())) {
            return id.column();
        }

        cn.guolf.guoblog.lib.database.annotation.Foreign foreign = field.getAnnotation(cn.guolf.guoblog.lib.database.annotation.Foreign.class);
        if (foreign != null && !TextUtils.isEmpty(foreign.column())) {
            return foreign.column();
        }

        cn.guolf.guoblog.lib.database.annotation.Finder finder = field.getAnnotation(cn.guolf.guoblog.lib.database.annotation.Finder.class);
        if (finder != null) {
    ...
    public static boolean isForeign(Field field) {
        return field.getAnnotation(cn.guolf.guoblog.lib.database.annotation.Foreign.class) != null;
    }

    public static boolean isFinder(Field field) {
        return field.getAnnotation(cn.guolf.guoblog.lib.database.annotation.Finder.class) != null;
    }

    public static boolean isUnique(Field field) {
        return field.getAnnotation(cn.guolf.guoblog.lib.database.annotation.Unique.class) != null;
    }
